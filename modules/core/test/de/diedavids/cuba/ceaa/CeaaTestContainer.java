...
public class CeaaTestContainer extends TestContainer {

    public CeaaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/ceaa/app.properties",
    ...
    public static class Common extends CeaaTestContainer {

        public static final CeaaTestContainer.Common INSTANCE = new CeaaTestContainer.Common();
